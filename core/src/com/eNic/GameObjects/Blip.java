...
public class Blip {
    ...
    private TweenManager managerUndetectIn, managerUndetectOut,
	    managerDetectIn, managerDetectOut;
    private Value alphaUndetectIn = new Value(),
	    alphaUndetectOut = new Value(), alphaDetectIn = new Value(),
	    alphaDetectOut = new Value();
